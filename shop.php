        ...
        <!-- NAVBAR -->
            <nav class="navbar navbar-expand-lg px-2 sticky-top navbar-dark">
                <div class="container-fluid">
                    <ul></ul>
                    <a class="navbar-brand text-white fw-bold" style="font-size:15px" href="#">Zsaliah's Closet Online Shop <i class="fas fa-columns px-1"></i></a>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">       
                        <form id="searchForm" class="d-flex px-5">
                            ...
                            <button id="search_btn" class="btn text-white" style="background-color: #A45C40!important" type="submit">Search</button>    
                        </form>                 
                    ...
                    <div class="col-md-2">
                        <div class="sidenav">
                            <div class="sideHeader">
                                <div class="col-4 px-4"><h4><span style="color:#C38370;">Fashion</span> <br>Categories</h4></div>
                            </div>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-10 text-dark" style="font-weight:500;">
                                    &copy;ZSALIAH'S CLOSET ONLINE SHOP || <bold style="color:#9457eb"  id="yearDisplay"></bold>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="container-fluid" >
                                <div class="row g-4">
                                    <div class="col-11">
                                        <h5 class="modal-title"><i class="fas fa-shopping-cart px-1"></i>Cart <span style="color:#C38370;">Details</span></h5>
                                    </div>
                                    <div class="col-1">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-11">
                                    <h5 class="modal-title"> <i class="far fa-id-card"></i> MANAGE <span style="color:#9457eb;">PROFILE</span></h5>
                                </div>
                                <div class="col-1">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                            ...
                            <form id="updateForm">
                                    ...
                                    <div class="row">
                                         ...
                                         <div class="col-4" style="padding-top:22px;">
                                             <button type="button" id="updateBtn" name="updateBtn" class="btn text-white px-5 py-3"  style="background-color: #9457eb !important; border-radius:8px; ">SAVE</button>
                                        </div>
                                    </div>
                                </div> 
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-11">
                                    <h5 class="modal-title"><i class="fas fa-history px-1"></i> Purchased <span style="color:#9457eb;">History</span></h5>
                                </div>
                                <div class="col-1">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row g-4">
                                <div class="col-11">
                                    <h5 class="modal-title"><i class="fas fa-truck"></i> Pending <span style="color:#C38370;">Order</span></h5>
                                </div>
                                <div class="col-1">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-5 ms-auto">
                                <button type="button" id="updateButton" name="updateButton" class="btn text-white py-2 px-4"  style="background-color: #9457eb !important;">Save changes</button>
                            </div>
                        </div>  
                    </div>
                    </div>
