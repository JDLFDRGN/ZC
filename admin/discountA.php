...
<body>
    ...
    <!-- MAIN CONTENT -->
        ...
        <div style="margin-left:15%">
            <div class="container bg-white pt-5 mt-2">
                <h4 class="mb-3 pt-5"><i class="bi bi-calendar3-fill"></i> DISCOUNT ACTIVE</h4>
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="/ZC/admin/discountA.php">&nbsp;&nbsp;ACTIVE&nbsp;&nbsp;</a>
                    </li>
                    <!-- <li class="nav-item">
                        <a class="nav-link" style="color:#AD8B73;" href="/ZC/admin/clothesNS.php">NO STOCK</a>
                    </li> -->
                    <li class="nav-item">
                        <a class="nav-link" style="color:#AD8B73;" href="/ZC/admin/discountNA.php">NOT ACTIVE</a>
                    </li>
                </ul>
                <div class="d-flex col-12 mt-4">
                    <a type="button" class="btn text-white mx-1" style="background-color: #826F66 !important;" href="/ZC/admin/discountA.php"> <i class="fas fa-redo px-1"></i> REFRESH </a>
                    <button type="button" class="btn text-white mx-1" style="background-color: #826F66 !important;" data-bs-toggle="modal" data-bs-target="#addDish"> <i class="fas fa-plus px-1"></i> ADD DISCOUNT</button>
                </div>
            </div>
        ...
        <div class="modal fade" id="addDish" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-11">
                            <h5 class="modal-title" id="exampleModalLabel" style="font-size:23px;"><i class="fas fa-plus"></i> New <span style="color:#AD8B73;">Discount</span> </h5>
                        </div>
                        <div class="col-1">
                    ...
                    <div class="row g-4 mb-1">
                        <div class="col-4">
                            ...
                            <input type="text" class="form-control" name="closetCode" id="closetCode" required>
                        </div>
                        <div class="col-4">
                            <label class="form-label">Name:</label>
                            <select class="form-label form-control" name="customerName" id="customerName" required>
                                <option value="">All</option>
                            </select>
                        </div>
                        <div class="col-4">
                            <label class="form-label">Percentage:</label>
                            <input type="text" min="0" class="form-control" name="closetPercentage" id="closetPercentage" required>
                        </div>
                        <!-- <div>
                            <label class="form-label">Product:</label>
                            <select class="form-label form-control" name="closetProduct" id="closetProduct" required></select>
                        </div> -->
                        <div>
                            <label class="form-label">Expiration:</label>
                            <input type="date" min="0" class="form-control" name="closetExpiration" id="closetExpiration" required>
                        </div>
                    </div>
                <div class="row mt-4">
                    <div class="col-5 ms-auto">
                        <button type="button" class="btn text-white" style="background-color: #826F66 !important;" name="closetSubmit" id="closetSubmit">Add Discount</button>
                    </div>
                </div>
            </form>
                </div>
    ...
    <!-- UPDATE DISH MODAL -->
    <div class="modal" id="updateDiscountModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                <div class="modal-body">
                    <div class="row mb-3">
    ...
    <!-- ADD DISH FUNCTION -->
        <script>
            ...
            if($('#closetCode').val() == '' || $('#customerName').val() =='' || $('#closetProduct').val() == '' || $('#closetPercentage').val() =='' || $('#closetExpiration').val() ==''){
                Swal.fire(
                'Insert Failed',
                ...
                $.ajax({
                url: "/ZC/admin/php/newDiscount.php",
                method: "POST",
                dataType: "text",
                data:data,
                cache: false,
    ...
    <!-- FUNCTION FOR FETCH DATA FOR THE UPDATE MODAL -->
         <script>    
                function update(id){
                    ...
                    //     $('#updateName').val(response[0].closetCode)
                    //     $('#updateCategory').val(response[0].closetCategory)
                    //     $('#updateStock').val(response[0].closetPercentage)
                    //     $('#updateDescription').val(response[0].closetDescription)
                    //     $('#updatePrice').val(response[0].customerName)
                    //     })
                }
            </script>
            ...
            <script>    
               function updateStatus(id){
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                            url: '/ZC/admin/php/discountDeactivate.php',
                            type: 'POST',
                            dataType: 'json',
                            data: {discountStatusID: id},
                        });
                        Swal.fire({
            ...
            <script>
                $(document).ready(function(){
                    $("#myInput").on("keyup", function() {
                        ...
                        $("#discountData tr").filter(function() {
    ...
    <!-- FUNCTION FOR FETCH closet DATA FOR TABLE -->
        <script>
            function getclosetA(){
                $.ajax({
                    url	:	"/ZC/admin/fetchdata/getDiscount.php",
                    method:	"POST",
                    data	:	{getDiscountA:1},
                    success	:	function(data){
                        $("#discountData").html(data);
                    }
                })
            }
        </script>
    <!-- FUNCTION FOR FETCH closet DATA FOR TABLE-->
        ...
        <script>
            function getClosetOptionA(){
                $.ajax({
                    url	:	"/ZC/admin/fetchdata/getClosetOption.php",
                    method:	"POST",
                    data	:	{getclosetOptionA:1},
                    success	:	function(data){
                        $("#closetProduct").html(data);
                    }
                })
            }
        </script>
        ...
        <script>
            function getCustomerOptionA(){
                $.ajax({
                    url	:	"/ZC/admin/fetchdata/getCustomerOption.php",
                    method:	"POST",
                    data	:	{getCustomerOptionA:1},
                    success	:	function(data){
