...
<?php session_start();?>
        ...
        <div style="margin-left:15%">
            <div class="container bg-white pt-5 mt-2 ">
                ...
                <ul class="nav nav-tabs mb-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link"  style="color:#AD8B73;" href="/ZC/admin/Completed.php">COMPLETED</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active"  href="/ZC/admin/Cancel.php">&nbsp;&nbsp;CANCEL&nbsp;&nbsp;</a>
                        </li>
                </ul>
                    <div class="row">
                            <div class="row mb-3">
    ...
    <!-- JAVASCRIPT -->
        ...
        <script src="/v/admin/js/logout.js"></script>
