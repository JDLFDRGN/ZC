        ...
        <div style="margin-left:13%">
            <div class="container bg-white pt-5 mt-2">
                ...
                <ul class="nav nav-tabs mb-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/ZC/admin/clothesNS.php">&nbsp;&nbsp;NO STOCK&nbsp;&nbsp;</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="d-flex col-12">
                    <a type="button" class="btn text-white mx-1" style="background-color:  #826F66 !important;" href="/ZC/admin/clothesNS.php"> <i class="fas fa-redo px-1"></i> REFRESH </a>
                </div>
            </div>
