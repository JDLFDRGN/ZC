            ...
            <div class="container bg-white pt-5 mt-2 ">
                <h4 class="mb-3 pt-5"><i class="fas fa-user"></i> CUSTOMER DETAILS</h4>
                    <ul class="nav nav-tabs mb-4">
                        <li class="nav-item">
                            <a class="nav-link active" href="/ZC/admin/customerA.php">&nbsp;&nbsp;ACTIVE&nbsp;&nbsp;</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="color:#AD8B73;" href="/ZC/admin/customerNA.php">NOT ACTIVE</a>
                        </li>
                    </ul>
            <div class="d-flex col-12">
                <a type="button" class="btn text-white" style="background-color: #B97D60 !important;" href="/ZC/admin/customerA.php"> <i class="fas fa-redo px-1"></i> REFRESH </a>
            </div>
        </div>
               ...
               function updateStatus(id){
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                            url: '/ZC/admin/php/cusDeactivate.php',
                            type: 'POST',
                            dataType: 'json',
                        ...
                        if (result.isConfirmed) {
                            window.location = "/ZC/admin/customerNA.php";
                        }
                        })
                        }
                        })
    ...
    <!-- FUNCTION FOR FETCH CUSTOMER DATA FOR TABLE -->
        <script>
            function getCustomer(){
                $.ajax({
                    url	:	"/ZC/admin/fetchdata/getCustomer.php",
                    method:	"POST",
                    data	:	{getCustomerA:1},
