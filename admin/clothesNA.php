...
<?php session_start();?>
    ...
    <!-- MAIN CONTENT -->
        <div class="w3-sidebar w3-bar-block text-dark" style="width:15%; background-color: #B97D60 !important;">
            <h3 class="w3-bar-item text-light text-center"><img class="card-img-top pt-5" style="border-radius:50%;" src="/ZC/admin/assets/images/logo.png"></h3>
        ...
        <div style="margin-left:15%">
            <div class="container bg-white pt-5 mt-2">
                ...
                <ul class="nav nav-tabs mb-4">
                    <li class="nav-item">
                        <a class="nav-link" style="color:#AD8B73;" href="/ZC/admin/clothesA.php">ACTIVE</a>
                    </li>
                    <!-- <li class="nav-item">
                        <a class="nav-link" style="color:#AD8B73;" href="/ZC/admin/clothesNS.php">NO STOCK</a>
                    </li> -->
                    <li class="nav-item">
                        <a class="nav-link active" href="/ZC/admin/clothesNA.php">&nbsp;&nbsp;NOT ACTIVE&nbsp;&nbsp;</a>
                    </li>
                </ul>
                <div class="d-flex col-12">
                    <a type="button" class="btn text-white mx-1" style="background-color: #826F66 !important;" href="/ZC/admin/clothesNA.php"> <i class="fas fa-redo px-1"></i> REFRESH </a>
                </div>
            </div>
            ...
            <div class="container my-2 pt-1">
                ...
                <table id="closetTable" style="border:none;" class="table table-borderless table-striped text-center align-middle" style="border-top:1px solid black;">
                    ...
                    <tbody id="closetData" class="text-center"></tbody>
                </table>
            </div>
        </div>
    <!-- MAIN CONTENT END -->
               ...
               function updateStatus(id){
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                            url: '/ZC/admin/php/dishActivate.php',
                            type: 'POST',
                            dataType: 'json',
    ...
    <!-- FUNCTION FOR FETCH closet DATA -->
        <script>
            function getclosetNA(){
                $.ajax({
